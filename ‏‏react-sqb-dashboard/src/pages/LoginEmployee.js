...
function LoginEmployee() {
  ...
  return (
    <div >
      ...
      <h1 >LoginEmployee</h1>
      <Form className="mt-2" onSubmit={loginEmployee}>
        ...
        <Form.Group className="my-5"style={{marginRight:"50px"}}>
          ...
          <Col >
            <span>
            <p style={{ backgroundColor:"#797978",width:"50%",borderRadius:"6px",padding:"5px",marginRight:"60px",}}>
            <button className="btn" type="submit"><h6>Login Employee</h6></button>
            </p>
            <p style={{ backgroundColor:"#797978",width:"50%",borderRadius:"6px",padding:"1px ",marginRight:"130px"  }}>
